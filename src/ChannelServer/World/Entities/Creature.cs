...
namespace Aura.Channel.World.Entities
{
	...
	public abstract class Creature : Entity, IDisposable
	{
        ...
        /// <summary>
		/// Holds the time at which the invulnerability time is over. TODO: Remove this once the Hit lock becomes available?
		/// </summary>
		public DateTime NotReadyToBeHitTime { get; set; } //TODO: Remove this once the Hit lock becomes available?

        /// <summary>
        /// Returns true if creature is not able to get hit yet. TODO: Remove this once the Hit lock becomes available?
        /// </summary>
